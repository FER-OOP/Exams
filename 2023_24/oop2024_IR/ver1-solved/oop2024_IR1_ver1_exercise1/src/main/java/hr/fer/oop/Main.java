...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        unicorn.gallop();
        System.out.println(unicorn.getName() + " has " + unicorn.getEnergy() + " energy and " + unicorn.getPower() + " power after galloping");
        ...
        flyingCreature.fly();
        System.out.println(flyingCreature.getName() + " has " + flyingCreature.getEnergy() + " energy and " + dragon.getPower() + " power after flying");
