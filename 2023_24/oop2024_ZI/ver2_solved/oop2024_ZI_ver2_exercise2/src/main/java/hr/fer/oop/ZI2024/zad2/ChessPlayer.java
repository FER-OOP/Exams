...
public class ChessPlayer implements Comparable<ChessPlayer>{
	...
	public static final Comparator<ChessPlayer> BY_LASTNAME = (o1, o2) -> hrcomparator.compare(o1.lastname, o2.lastname);
	public static final Comparator<ChessPlayer> BY_FIRSTNAME = (o1, o2) -> hrcomparator.compare(o1.firstname, o2.firstname);
	public static final Comparator<ChessPlayer> BY_RATING = (o1, o2) -> Integer.compare(o1.rating, o2.rating);	
	...
	public int compareTo(ChessPlayer o) {
		Comparator<ChessPlayer> cNatural = BY_LASTNAME.thenComparing(BY_FIRSTNAME).thenComparing(BY_RATING.reversed());
	...
	public boolean equals(Object obj) {
		...
		return rating == other.rating && Objects.equals(firstname, other.firstname) && Objects.equals(lastname, other.lastname);
	}
