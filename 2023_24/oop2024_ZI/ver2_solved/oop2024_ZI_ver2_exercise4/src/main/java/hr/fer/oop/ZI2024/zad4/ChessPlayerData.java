...
public class ChessPlayerData {
	...
	public static List<ChessPlayer> loadChessPlayersCro() {
		...
		players.add(new ChessPlayer("Jadranko", "Plenca", Country.CROATIA, 2447, 1999));
	...
	public static List<ChessPlayer> loadChessPlayersSmall() {
		...
		players.add(new ChessPlayer("Tom", "Cruise", Country.USA, 1500, 1990));
		players.add(new ChessPlayer("Tom", "Cruise", Country.USA, 1600, 1992));
		players.add(new ChessPlayer("Bruce", "Lee", Country.CHINA, 1500, 1963));
		players.add(new ChessPlayer("Bruce", "Lee", Country.RUSSIA, 1605, 1973));
		players.add(new ChessPlayer("Nodirbek", "Abdusattorov", Country.UZBEKISTAN, 2766, 2004));
		players.add(new ChessPlayer("Gukesh", "Dommaraju", Country.INDIA, 2763, 2006));
		players.add(new ChessPlayer("Bruce", "Willis", Country.USA, 1997, 1973));
		players.add(new ChessPlayer("Aksel", "Hennie", Country.NORWAY, 2101, 1975));
		Collections.shuffle(players);
