...
public class Main {
    ...
    public static void main(String[] args)
    {
        ...
        System.out.println("age range count: " + BillionaireStats.countAgeRange(dataset, 16,29));

        for (Map.Entry<Integer,Long> worthBucket : BillionaireStats.makeHistogram(dataset,10000).entrySet())
        {
