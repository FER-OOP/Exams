...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        class ExtendedCollectionBag<T> extends CollectionBag<T> {
        ...
        ExtendedCollectionBag<String> bg1 = new ExtendedCollectionBag<>();
        ExtendedCollectionBag<String> bg2 = new ExtendedCollectionBag<>();
