...
public class Lambdas {
    ...
    public static TriFunction<Collection<WeatherRecord>, Predicate<WeatherRecord>, Comparator<WeatherRecord>, Collection<WeatherRecord>> getFilteredAndSortedFromCollection = (collection, predicate, comparator)
            -> collection.
                    stream().
                    filter(predicate).
                    sorted(comparator).
    ...
    public static TriFunction<Map<Integer, Collection<WeatherRecord>>, Predicate<WeatherRecord>, Comparator<WeatherRecord>, Collection<WeatherRecord>> getFilteredAndSortedFromMap = (map, predicate, comparator)
            -> map.
                    values().
                    stream().
